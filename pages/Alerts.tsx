    ...
    <div className="animate-fade-in space-y-6">
      ...
      <div className="grid grid-cols-1 gap-4 max-w-3xl">
        {loading ? (
          ...
          <div className="bg-white dark:bg-[#111121] border-2 border-dashed border-slate-100 dark:border-slate-800 rounded-3xl p-16 text-center shadow-sm">
          ...
          <div key={alert.id} className="bg-white dark:bg-[#111121] border border-slate-200 dark:border-slate-800/80 p-5 rounded-3xl flex items-start gap-5 hover:shadow-lg hover:border-orange-200 dark:hover:border-orange-900/30 transition-all duration-300 group">
            ...
            <div className="flex-1 space-y-2">
              ...
              <div className="flex gap-2 pt-3">
                ...
                <button className="px-4 py-1.5 bg-orange-600 text-white text-[9px] font-black uppercase tracking-widest rounded-lg hover:bg-orange-700 shadow-sm transition-all active:scale-95">Resolver</button>
              </div>
            </div>
          </div>
        ))}
